...
class Triangle : public Object {
    ...
    public:
    Triangle() {}
    Triangle(const std::vector<vec3>* v, const std::vector<vec3>* n,
             size_t v1, size_t v2, size_t v3, size_t n1, size_t n2, size_t n3,
             size_t idx)
        : verts(v), norms(n), v1(v1), v2(v2), v3(v3),
            n1(n1), n2(n2), n3(n3), idx(idx) {}
