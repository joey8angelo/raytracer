...
Hit Triangle::intersection(const Ray& ray) const {
    ...
    if (u < 0 || u > 1) {
        if (debug) {
            // std::cout << "[Triangle::intersection] u: " << u
            //           << std::endl;
        }
        return {NULL, 0, 0};
    }
    ...
    if (v < 0 || u + v > 1) {
        if (debug) {
            // std::cout << "[Triangle::intersection] v: " << v
            //           << " u: " << u << std::endl;
        }
        return {NULL, 0, 0};
    }
    ...
    if (t >= small_t) {
        ...
        // if (debug) {
        //     std::cout << "[Triangle::intersection] t: " << t
        //               << std::endl;
        // }
        return {NULL, 0, 0};
    }
...
vec3 Triangle::normal(const vec3& point, size_t face_idx) const {
    ...
    if (n1 == n2 && n2 == n3 && n1 == 0) {
        ...
        return cross(verts->at(v2) - verts->at(v1), verts->at(v3) - verts->at(v1)).normalized();
    } else {
        ...
        if (debug) {
            std::cout << "[Triangle::normal] barycentric coords: " << x << " " 
                      << y << " " << z << std::endl;
            std::cout << "[Triangle::normal] normals: " << norms->at(n1) << " " << norms->at(n2) << " " 
                      << norms->at(n3) << std::endl;
        }
        ...
        if (debug) {
            std::cout << "[Triangle::normal] interpolated normal: " << res << std::endl;
        }
